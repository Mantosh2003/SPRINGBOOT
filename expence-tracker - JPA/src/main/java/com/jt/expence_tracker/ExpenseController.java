...
public class ExpenseController {
    ...
    //     return jdbcTemplate.query(sql,new BeanPropertyRowMapper<Expense>(Expense.class));
       return expenseRepository.findAll();  //find all the entity of the table
    ...
    //     Expense expense=optExp.orElseThrow(()-> new RuntimeException("Unable to find with id:- "+ id));
    //     return expense;

    
       return expenseRepository.findById(id).orElseThrow(() -> new RuntimeException("Unable to find with id:- " + id));
